...
public class PedidoController extends javax.swing.JFrame {
    ...
    private void preencheCabecalho(Pedido pedido) {
        if (pedido.getId() == 0) {
            ...
            jtfValor.setText(ValorTotalPedido + "");
        } else {
            jtfId.setText(pedido.getId() + "");
            jtfCliente.setText(pedido.getCliente().getNome());
            jtfData.setText(pedido.getData().toString());
            jtfValor.setText(pedido.getValorTotal() + "");
        }
    ...
    private void initComponents() {
        ...
        jtfValor.setName(""); // NOI18N
        jtfValor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtfValorMouseClicked(evt);
            }
        });
    ...
    private void jtfValorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtfValorMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfValorMouseClicked
